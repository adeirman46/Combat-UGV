...
# ===================================================================================
# LAUNCH FILE: Ouster OS1-128 LiDAR Simulation (Gz Fortress)
# ===================================================================================
# Replaces the VLP-16 with an Ouster OS1-128 for dramatically denser point clouds.
# 128 channels × 2048 H-samples = 262,144 points/scan vs VLP-16's 28,800.
# ===================================================================================
...
def generate_launch_description():
    ...
    xacro_file       = os.path.join(pkg_ugv_bringup, 'urdf', 'ugv_pindad_ouster.urdf.xacro')
    world_file       = os.path.join(pkg_ugv_bringup, 'worlds', 'obstacle.world')
    rviz_config_file = os.path.join(pkg_ugv_bringup, 'config', 'ouster_lidar_view.rviz')
    ...
    bridge_args = [
        ...
        # lidar: Gz -> ROS (Note: Gz suffix /points/points is managed via remapping)
    ...
    lidar_frame_bridge = Node(
        ...
        arguments=[
            ...
            '--frame-id', 'lidar_link',
            '--child-frame-id', 'ugv_pindad/base_footprint/ouster_os1_128',
        ],
